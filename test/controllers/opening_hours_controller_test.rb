...
class OpeningHoursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opening_hour" do
    assert_difference('OpeningHour.count') do
      post opening_hours_url, params: { opening_hour: { close: @opening_hour.close, day: @opening_hour.day, open: @opening_hour.open, shop_id: @opening_hour.shop_id } }
    end
  ...
  test "should update opening_hour" do
    patch opening_hour_url(@opening_hour), params: { opening_hour: { close: @opening_hour.close, day: @opening_hour.day, open: @opening_hour.open, shop_id: @opening_hour.shop_id } }
